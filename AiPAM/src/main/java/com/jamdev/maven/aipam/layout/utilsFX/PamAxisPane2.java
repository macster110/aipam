...
public class PamAxisPane2 extends StackPane {
	 ...
	 * 
	 *  */
	private NumberAxis[] axis = new NumberAxis[AIPamParams.MAX_CHANNELS]; 
	 ...
	 */
	private boolean cramp = true; //TODO implement propely. 
		...
		public String toString(Number value) {
			try {
				...
				if (labelScale == 0 || labelScale == 1.) {
					if (!reverseAxis.get()) return baseFormatter.toString(value);
					else return baseFormatter.toString(new Double(-value.doubleValue()));
				}
				else {
