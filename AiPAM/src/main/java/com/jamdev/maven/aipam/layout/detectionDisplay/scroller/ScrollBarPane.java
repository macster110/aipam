...
import com.jamdev.maven.aipam.clips.datetime.SoundSpotCalendar;
 ...
 *
 */
public class ScrollBarPane extends BorderPane {
	...
	private void  textBoxErrorFlash(Node textBox){
		...
		UtilsFX.nodeFlashEffect(textBox, Color.RED, 20d, 0.3 );
	...
	private void setTextBoxValue(double visAmount) {
		if (isShowMillis()){
			...
			textBox.setText(SoundSpotCalendar.formatDuration((long) visAmount));
		}
	}
	...
	/**
	 * Set the minimum value of the scroll pane. i.e. the minimum possible value of the current value. . 
	 * @param the minimum possible value of the scroll pane. 
	 */
	...
	/**
	 * The maximum value of the scroll pane. i.e. the maximum possible value of the current value. . 
	 * @return the maximum possible value of the scroll pane. 
	 */
	...
	/**
	 * Set maximum value of the scroll pane. i.e. the maximum possible value of the current value. . 
	 * @param the maximum possible value of the scroll pane. 
	 */
